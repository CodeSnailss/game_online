$(document).ready(function () {
    ...
    $(".start").click(function () {
        // 提示
        if (document.getElementById("txt1").value >50) {
            alert("X速度范围(5-50)");
            document.getElementById("txt1").focus();
            return (false);
        }
        if (document.getElementById("txt1").value <5) {
            alert("X速度范围(5-50)");
            document.getElementById("txt1").focus();
            return (false);
        }
        if (document.getElementById("txt2").value >50) {
            alert("Y速度范围(5-50)");
            document.getElementById("txt2").focus();
            return (false);
        }
        if (document.getElementById("txt2").value <5) {
            alert("Y速度范围(5-50)");
            document.getElementById("txt2").focus();
            return (false);
        }
        if (document.getElementById("txt3").value >50) {
            alert("出弹量范围为(5-50)");
            document.getElementById("txt3").focus();
            return (false);
        }
        if (document.getElementById("txt3").value <2) {
            alert("出弹量范围为(2-50)");
            document.getElementById("txt3").focus();
            return (false);
        }
        if (document.getElementById("txt4").value < 2) {
            alert("数量不能少于2");
        ...
        document.onkeydown = function (e) { //键盘按下事件绑定
            ...
            switch (e.keyCode) {
                case 37: //左
                    fj.style.left = Math.max(0, fj.offsetLeft - 20) + "px";
                    console.log("左");
                    break;
                case 38: //上
                    fj.style.top = Math.max(0, fj.offsetTop - 20) + "px";
                    console.log("上");
                    break;
                case 39:  //右
                // 外层宽减去内层宽
                    fj.style.left = Math.min(720, fj.offsetLeft + 20) + "px";
                    console.log("右");
                    break;
                case 40:  //下
                // 外层高减去内层高
                    fj.style.top = Math.min(420, fj.offsetTop + 20) + "px";
                    console.log("下");
                    break;
            }
        }
